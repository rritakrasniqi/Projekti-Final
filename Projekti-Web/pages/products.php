...
if($response){ 
   echo "<div class='produktet'>";
    while($row = mysqli_fetch_array($response)){
      echo '<form name="form_'.$row['ID_produkti'].'" id="form_'.$row['ID_produkti'].'" method="POST" action="../includes/cart.php?id="1">';
        ...
        echo "<div class='cmimi'><input type=\"button\" onclick=\"addToCart(".$row['ID_produkti'] .  ")\" value=\"add to cart\" \></div>" ; 
        echo '</form>';
        echo "</div>";
      }echo "</div>";
}
